                    ...
                    <div className="flex gap-[30px] md:gap-[60px] flex-col justify-center items-center my-[30px] md:my-[60px] font-inter">
                        ...
                        <div className="flex justify-between  w-full ">
                            ...
                            spaceBetween={32}
                                ...
                                {
                                    homejson.HowItWorks.map((item:any, index:number) => (
                                        <SwiperSlide >
                                            <div key={index } className="flex cursor-pointer flex-col gap-[26px] md:gap-[30px] max-w-[299px] md:max-w-[419px] w-full p-[20px] md:p-[30px] rounded-3xl border border-[#d8d8d8] bg-lightGray ">
