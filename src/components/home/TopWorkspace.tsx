          ...
          <div className="flex flex-col md:gap-[60px] gap-[30px] font-inter py-[30px] md:py-[60px]  ">
            ...
            <div className="flex w-full justify-between">
              <Swiper
                ...
                className="mySwiper"
              >
                {homejson.TopWorkspace.map((item:any, index:Number) => (
                  <SwiperSlide>
                    <div
                      key={item + index}
                      className="flex flex-col md:max-w-[419px] max-w-[336px] w-full overflow-hidden bg-whiteGray  rounded-3xl"
                    >
                      ...
                      <div className="flex flex-col md:p-[24px_20px_40px_20px] p-[20px_19px_30px_20px]">
                        ...
                        <div className="flex w-full justify-between md:pb-[21px] pb-[24px]">
                          {item.benifits.map((item:any, index:number) => (
                            <h4 key={index} className="px-4 py-2 rounded-xl md:text-xs text-[10px] leading-[130%] bg-white">
                              {item.title}
                            </h4>
                          ))}
                        </div>
