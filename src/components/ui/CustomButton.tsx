...
const CustomButton = ({
  ...
  const typeClasses = {
    ...
    gradient: 'text-white linear_color hover:brightness-110',
  };
  ...
  return (
    <button
      ...
      className={`${baseClasses} ${typeClasses[type]} font-inter ${isLoading || disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer '} ${className}`}
    >
